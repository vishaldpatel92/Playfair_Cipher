...
public class Playfair {
    ...
    private char   Key_Mat[][] = new char[5][5];
    ...
    private void matrix()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            for (int j = 0; j < 5; j++)
            {
                Key_Mat[i][j] = Key.charAt(counter);
    ...
    public String encryptMessage(String Source)
    {
        ...
        for (int i = 0; i < src_arr.length; i++)
        {
            ...
            Code = Code + Key_Mat[part1[0]][part1[1]]
                    + Key_Mat[part2[0]][part2[1]];
        }
        return Code;
    }
    ...
    public String decryptMessage(String Code)
    {
        ...
        for (int i = 0; i < src_arr.length; i++)
        {
            ...
            Original = Original + Key_Mat[part1[0]][part1[1]]
                    + Key_Mat[part2[0]][part2[1]];
        }
        return Original;
    }
